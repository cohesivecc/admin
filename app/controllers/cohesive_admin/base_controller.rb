  ...
  class BaseController < ApplicationController
    ...
    def index
      respond_to do |format|
        format.html { render 'cohesive_admin/base/index' }
    ...
    def sort
      ...
      render 'cohesive_admin/base/sort'
    end
      ...
      def set_header
        ...
        @header = (@object ? object_header : klass_header.pluralize) rescue 'CMS'
			...
			def require_admin_config
				render 'cohesive_admin/base/missing_admin_config' and return if @klass.admin_config[:error] == :missing_admin_config
			end
