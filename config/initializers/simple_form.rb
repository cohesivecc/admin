...
SimpleForm.setup do |config|
  ...
  # whole input.
  config.wrappers :switch, tag: :div, class: :switch, error_class: 'has-error'  do |b| #hint_class: :field_with_hint, error_class: 'has-error'
  # config.wrappers :switch do |b|
    b.use :html5
    b.optional :readonly
    ...
    b.wrapper tag: :label do |l|
      l.use :input
      l.use :label, wrap_with: { tag: :span, class: :lever }
    end
  ...
  config.wrappers :checkbox, error_class: 'has-error'  do |b|
    b.use :html5
    b.optional :readonly
    ...
    b.wrapper tag: :label do |l|
      l.use :input
      l.use :label_text, wrap_with: { tag: :span }
    end
  ...
  # config.input_class = 'materialize-textarea'
